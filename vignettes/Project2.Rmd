...
To make a multivariate linear regression for data, we utilized the lm() function alongside generalized code that is easily adapted to a range of data set sizes and complexities.
